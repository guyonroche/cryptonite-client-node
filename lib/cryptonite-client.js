...
module.exports = class CryptoniteClient extends EventEmitter {
  ...
  getMyOrders(market, start = Date.now() * 1000, limit = 100) {
    const url = market ?
      `${this.protocol}//${this.hostname}/api/v1/broker/${market}/my-orders` :
      `${this.protocol}//${this.hostname}/api/v1/broker/my-orders`;
  ...
  getMyTransactions(currency, start = Date.now() * 1000, limit = 100) {
    const url = currency ?
      `${this.protocol}//${this.hostname}/api/v1/broker/${currency}/my-transactions` :
      `${this.protocol}//${this.hostname}/api/v1/broker/my-transactions`;
  ...
  getMyTrades(market, start = Date.now() * 1000, limit = 100) {
    const url = market ?
      `${this.protocol}//${this.hostname}/api/v1/broker/${market}/my-trades` :
      `${this.protocol}//${this.hostname}/api/v1/broker//my-trades`;
  ...
  getTrades(market, start = Date.now() * 1000, limit = 100) {
