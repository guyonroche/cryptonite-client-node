const run = (trader1, trader2, trader3) => {
  ...
  return  trader1.placeLimitOrderSpread(0.25, 0.5, 5, 0.01)
    ...
    .then(() => trader1.waitFor(() => trader1.hasMatchingTrade(0.5, 0.26), 'Trader 1 receive a trade of 1 LTC at 0.26'))
    .then(() => trader2.waitFor(() => trader2.hasMatchingTrade(0.5, 0.26), 'Trader 2 receive a trade of 1 LTC at 0.26'))
